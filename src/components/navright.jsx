                  ...
                  <div className="total-container">
                    ...
                    <div className="cart-details">
                      <div className="cartdetails-row">
                        ...
                        <div className="itemcontent">NGN {itemsprice.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</div>
                      </div>
                      ...
                      <div className="details-row">
                        <div className="itemsprice">Total Commission</div>
                        <div className="itemcontent" style={{ color: "green" }}>
                          {''}
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div className="itemcontent"> NGN {totalprice.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</div>
                      </div>
                      {/* 
